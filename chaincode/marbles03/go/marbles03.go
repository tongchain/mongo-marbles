...
// ==== Invoke marbles ====
// peer chaincode invoke -C mychannel -n marbles03 -c '{"Args":["initMarble","marble1","blue","35","tom"]}'
// peer chaincode invoke -C mychannel -n marbles03 -c '{"Args":["initMarble","marble2","red","50","tom"]}'
// peer chaincode invoke -C mychannel -n marbles03 -c '{"Args":["initMarble","marble3","blue","70","tom"]}'
// peer chaincode invoke -C mychannel -n marbles03 -c '{"Args":["transferMarble","marble2","jerry"]}'
// peer chaincode invoke -C mychannel -n marbles03 -c '{"Args":["transferMarblesBasedOnColor","blue","jerry"]}'
// peer chaincode invoke -C mychannel -n marbles03 -c '{"Args":["delete","marble1"]}'

// ==== Query marbles ====
// peer chaincode query -C mychannel -n marbles03 -c '{"Args":["readMarble","marble1"]}'
// peer chaincode query -C mychannel -n marbles03 -c '{"Args":["getMarblesByRange","marble1","marble3"]}'
// peer chaincode query -C mychannel -n marbles03 -c '{"Args":["getHistoryForMarble","marble1"]}'

// Rich Query (Only supported if MongoDB is used as state database):
//   peer chaincode query -C myc1 -n marbles -c '{"Args":["queryMarblesByOwner","tom"]}'
//   peer chaincode query -C myc1 -n marbles -c '{"Args":["queryMarbles","{\"query\":{\"owner\":\"tom\"}}"]}'

// TODO INDEXES TO SUPPORT MONGODB RICH QUERIES
...
//  that support rich query (e.g. MongoDB).
...
// Only available on state databases that support rich query (e.g. MongoDB)
// =========================================================================================
func (t *SimpleChaincode) queryMarblesByOwner(stub shim.ChaincodeStubInterface, args []string) pb.Response {
	...
	queryString := fmt.Sprintf("{\"query\":{\"docType\":\"marble\",\"owner\":\"%s\"}}", owner)
